    ...
    <div id="main_persona" class="row" data-url="{{ url(config('usuarios.prefijo_ruta')) }}">
        ...
        <div class="col-xs-12 form-group">
            <div class="input-group">
                <input name="buscador" type="text" class="form-control" placeholder="Documento" id="buscador">
                ...
                <form action="" id="form_persona">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a id="btn-permisos" data-url="{{ url('/actividad_usuario/') }}" href="" class="btn btn-default" style="display: none;">Permisos</a>
